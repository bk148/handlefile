...
def send_email(subject, body):
    ...
    try:
        ...
        logging.info("Notification par e-mail envoyée avec succès.")
    ...
    for root, _, files in os.walk(package):
        for file_name in files:
            ...
            try:
                ...
                send_email("Échec du téléversement", f"Le fichier {file_name} n'a pas pu être téléversé : {e}")
...
def main():
    ...
    send_email("Livraison terminée", "Tous les fichiers ont été téléversés avec succès.")
